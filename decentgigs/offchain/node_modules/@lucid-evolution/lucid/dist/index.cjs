...
var selectionAndEvaluation = (walletInputs, changeAddress, coinSelection, localUPLCEval, includeLeftoverLovelaceAsFee, script_calculation) => import_effect18.Effect.gen(function* () {
  ...
  const availableInputs = import_effect18.Array.differenceWith(import_utils10.isEqualUTxO)(walletInputs, [
...
var evalTransaction = (config, txRedeemerBuilder, walletInputs) => import_effect18.Effect.gen(function* () {
  ...
  const slotConfig = import_plutus3.SLOT_CONFIG_NETWORK[config.lucidConfig.network];
...
var recursive = (inputs, requiredAssets, coinsPerUtxoByte, externalAssets = {}, includeLeftoverLovelaceAsFee, error) => import_effect18.Effect.gen(function* () {
  ...
  if (!import_effect18.Record.isEmptyRecord(requiredAssets)) {
    selected = (0, import_utils10.selectUTxOs)(inputs, requiredAssets, true);
  ...
  while (extraLovelace) {
    ...
    const extraSelected = (0, import_utils10.selectUTxOs)(remainingInputs, extraLovelace, true);
...
var Lucid = async (provider, network, options = {}) => {
  ...
  if (config.provider && "slot" in config.provider) {
    ...
    import_effect20.Effect.gen(function* () {
      ...
      import_plutus4.SLOT_CONFIG_NETWORK[custom] = {
...
// src/index.ts
__reExport(index_exports, require("@lucid-evolution/core-types"), module.exports);
__reExport(index_exports, require("@lucid-evolution/core-utils"), module.exports);
__reExport(index_exports, require("@lucid-evolution/plutus"), module.exports);
__reExport(index_exports, require("@lucid-evolution/provider"), module.exports);
__reExport(index_exports, require("@lucid-evolution/sign_data"), module.exports);
__reExport(index_exports, require("@lucid-evolution/utils"), module.exports);
__reExport(index_exports, require("@lucid-evolution/wallet"), module.exports);
